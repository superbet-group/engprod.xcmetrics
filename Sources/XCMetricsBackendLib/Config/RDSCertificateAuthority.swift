// Copyright (c) 2026 Superbet Group.
//
...
/// The eu-central-1 RDS/Aurora root CA bundle, downloaded from
/// https://truststore.pki.rds.amazonaws.com/eu-central-1/eu-central-1-bundle.pem.
/// Public certificate material. Used as the trust root for TLS connections to Postgres
/// (see `Configuration.databaseTLSEnabled`) since RDS/Aurora server certificates are
/// signed by this CA, which isn't present in the default system trust store.
let rdsCertificateAuthorityPEM = """
-----BEGIN CERTIFICATE-----
